...
const createDriver = async (req, res) => {
    const {name, email, phone_no, license_no, age, address, transmission} = req.body

    try {
        const driver = await Driver.create({name, email, phone_no, license_no, age, address, transmission})
        res.status(200).json(driver)
